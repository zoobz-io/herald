...
**[Publishing](2.learn/2.concepts.md#publishers)** — Forward capitan events to any supported broker with automatic serialization and metadata propagation.

**[Subscribing](2.learn/2.concepts.md#subscribers)** — Consume broker messages and emit them as capitan events, with automatic deserialization and acknowledgment.

**[Providers](2.learn/2.concepts.md#providers)** — 11 built-in providers for Kafka, NATS, JetStream, Pub/Sub, Redis, SQS, RabbitMQ, SNS, BoltDB, Firestore, and io.
